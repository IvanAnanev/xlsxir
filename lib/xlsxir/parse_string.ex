defmodule Xlsxir.ParseString do
  ...
  def sax_event_handler({:startElement,_,~c"si",_,_}, %__MODULE__{tid: tid, index: index}), do: %__MODULE__{tid: tid, index: index}
  ...
  def sax_event_handler({:endElement,_,~c"si",_},
